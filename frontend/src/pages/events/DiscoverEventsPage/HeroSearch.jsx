...
export default function HeroSearch() {
  return (
    <section className="bg-gradient-to-b from-primary/5 to-background py-10 sm:py-16 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto flex flex-col items-center text-center gap-3">
        ...
        <div className="mt-4 sm:mt-6 w-full bg-white rounded-lg border border-border shadow-sm flex flex-col md:flex-row items-stretch divide-y md:divide-y-0 md:divide-x divide-border">
          ...
          <button className="bg-primary text-white font-semibold px-8 py-3 rounded-b-lg md:rounded-b-none md:rounded-r-lg hover:bg-primary/90 transition-colors">
            Search
          </button>
        </div>
      </div>
