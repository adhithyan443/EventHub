...
export default function OtpPage() {
    ...
    // TODO: replace with the real masked email, passed via route state after registration
    const maskedEmail = "a******n@example.com";
    ...
    return (
        ...
        >
            <div className="flex flex-col items-center gap-6 w-full max-w-md">
                <div className="bg-white rounded-lg shadow p-8 w-full flex flex-col gap-8">
                    ...
                    <div className="flex flex-col gap-4">
                        <p className="text-center text-sm text-ink/60">
                            ...
                            {secondsLeft > 0 ? (
                                <span className="text-ink/40">Resend code in {formatTime(secondsLeft)}</span>
                            ) : (
                ...
                <p className="text-xs text-ink/50">© 2026 EventHub Inc.</p>
            </div>
        </AuthLayout>
    );
}