export default function ReviewPanel({ app, onClose, onReject, onApprove }) {
  if (!app) return null;
        ...
        <div className="px-6 py-5 border-b border-[#dce2f7] flex items-start justify-between bg-white shrink-0">
          <div>
            ...
            <p className="text-[#3d4947] text-sm font-medium">
              <span className="font-mono">{app.id}</span> • Submitted {app.submitted}
            </p>
          </div>
          <button
            type="button"
            ...
            <div className="p-4 space-y-4">
              ...
              <div>
                ...
                <div className="text-[#3d4947] text-sm leading-5">
                  {app.description ||
                    "Professional event management organization specializing in large-scale conferences, developer summits, and corporate workshops across India."}
                </div>
              </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-[#141b2b] text-sm font-medium">
                      business-verification-certificate.pdf
                    </div>
                    <div className="text-[#6d7a77] text-xs">2.4 MB • PDF Document</div>
                  </div>
                </div>
                <button
                  type="button"
                  onClick={() => alert("Document viewer opened")}
          ...
          <section className="bg-white border border-[#dce2f7] rounded-xl overflow-hidden shadow-sm">
            ...
            <div className="p-4 grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="text-[#141b2b] text-sm">Director / Lead Organizer</div>
              </div>
              <div>
                <div className="text-[#6d7a77] text-xs uppercase tracking-wide mb-1 font-medium">
                  Email
                ...
                <div className="text-[#00685f] text-sm font-medium break-all">
                  {app.email || "contact@eventmasters.in"}
                </div>
              </div>
              <div>
                <div className="text-[#6d7a77] text-xs uppercase tracking-wide mb-1 font-medium">
                ...
                <div className="text-[#141b2b] text-sm">+91 99988 77766</div>
              </div>
            </div>
          </section>
          ...
          <section className="bg-white border border-[#dce2f7] rounded-xl overflow-hidden shadow-sm">
            ...
            <div className="p-4 grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="text-[#141b2b] text-sm font-mono">••••••4521</div>
              </div>
              <div>
                <div className="text-[#6d7a77] text-xs uppercase tracking-wide mb-1 font-medium">
                  IFSC Code
